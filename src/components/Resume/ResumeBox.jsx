    ...
    <div id="resume" className="btn-shadow feature-box mb-10 rounded-md">
      <div className="py-11 px-10 h-full">
        <div className="flex justify-between lg:items-center pb-6 lg:flex-row flex-col">
          <div className="mb-2">
            <h3 className="text-xl text-white-300 mb-1">{title}</h3>
            <small className="text-white-400 text-sm">{subTitle}</small>
          </div>
        ...
        <div>
          <p className=" text-white-500 font-primary font-normal text-lg">
            {description}
          </p>
        </div>
      </div>
